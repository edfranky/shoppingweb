...
<body>
	...
	<a name="回頂端"></a>
        ...
        <center class="center" >
	        ...
	        <a href="usercenter.jsp" class="mem2"><font>|訂購紀錄</font><font>|</font></a>
			<font class="mem2"><center>✽ 您的會員資料 ✽</center></font><br>
			<table align="center">
				<tr>
					<td>姓名</td>
					<td>帳號</td>
				...
				<tr>
			<%
				sql="SELECT * FROM register WHERE id='"+(String)session.getAttribute("id")+"'";
				ResultSet rs=con.createStatement().executeQuery(sql);
				String name="",id="",pwd="",tel="",email="";
				while(rs.next())
				{
