...
<head>
	<meta charset="UTF-8">
	<title>修改會員資料</title>
	<link rel=stylesheet type="text/css" href="css/userdatachange.css">
	<script> 
...
<body>
	...
	<a name="回頂端"></a>
		...
		<footer>
		 <center class="center" >
		    <img src="images/right.png" alt="" class="img1">
	        <a href="userdatachange.jsp" class="mem2" ><font>|</font><font>更改會員資料</font><font>|</font></a>
	        <a href="usercenter.jsp" class="mem1"><font>訂購紀錄</font><font>|</font></a>
			<font class="mem1"><center>✽ 請修改您的會員資料✽</center></font>
		</center>

		  <form action="updateuserdata.jsp" method="POST" class="form1" align="center" name="change">
					您的帳號(驗證)<br><br><input type="id" name="id" value="" required="required"/> <br><br>
				   請輸入您要修改的姓名<br><br><input type="text" name="username" value="" required="required"/> <br><br>
				   請輸入您要修改的密碼<br><br><input type="password" name="pwd" value="" required="required"/> <br><br>
				   請輸入您要修改的電話<br><br><input type="text" name="tel" value="" required="required"/> <br><br>
			<input class="myButton" type="submit" value="更新資料" name="B1" onclick="datacheck()"><br>
			</form>
