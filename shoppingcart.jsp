	...
	<a name="回頂端"></a>
		...
		%>
		 ...
		 <%
			...
			{
		 %>
		      <td><a href="shoplist.jsp" class="buycar">馬上結帳</a></td>
		      <td><a href="goods.jsp" class="buycar" >繼續購物</a></td>
		      <td><a href="clearcart.jsp"  class="buycar"> 清空購物車</a></td></tr>
		<%
			}
			else
				{		
		%>
		     <td></td><td></td><td></td><td><a href="goods.jsp" class="buycar" >繼續購物</a></td>
		      <td><a href="clearcart.jsp"  class="buycar"> 清空購物車</a></td></tr>
         </table>
				  <% 
				  } 
